...
#define ACCELERATOR_1     H1_CONVOLUTION_LAYER | H3_CONVOLUTION_LAYER | H5_FULLY_CONNECTED_LAYER | HY_OUTPUT_LAYER
//#define ACCELERATOR_2     H5_FULLY_CONNECTED_LAYER
//#define ACCELERATOR_3     H3_CONVOLUTION_LAYER
//#define ACCELERATOR_4     H3_CONVOLUTION_LAYER
#define ACCELERATOR_5     H2_POOLING_LAYER | H4_POOLING_LAYER
