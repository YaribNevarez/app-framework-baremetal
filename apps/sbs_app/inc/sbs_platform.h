...
#define ACCELERATOR_1     H5_FULLY_CONNECTED_LAYER
#define ACCELERATOR_2     HY_OUTPUT_LAYER


#define ACCELERATOR_POOLING_LAYER   H2_POOLING_LAYER | H4_POOLING_LAYER
#define ACCELERATOR_CONVOLUTION_0   H1_CONVOLUTION_LAYER
#define ACCELERATOR_CONVOLUTION_1   H3_CONVOLUTION_LAYER
