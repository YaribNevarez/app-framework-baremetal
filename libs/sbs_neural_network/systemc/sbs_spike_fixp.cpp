...
void sbs_spike_fixp (hls::stream<StreamChannel> &stream_in,
...
#pragma HLS INTERFACE s_axilite port=return      bundle=CRTL_BUS
  ...
  static unsigned short data[MAX_VECTOR_SIZE];
#pragma HLS array_partition variable=data complete

  unsigned int debug_flags;

  static StreamChannel channel;
  static unsigned short random_value;
  ...
  {
    random_value = MT19937_rand () >> STATE_VECTOR_WIDTH;
...
#pragma HLS pipeline
        ...
        {
#pragma HLS pipeline
          data[index + i] = input >> (STATE_VECTOR_WIDTH * i);
        }
      }
    }
