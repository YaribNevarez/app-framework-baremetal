...
void
sbs_update_1024 (hls::stream<StreamChannel> &stream_in,
                 hls::stream<StreamChannel> &stream_out, int mode,
                 int layerSize, int kernelSize, int vectorSize, float epsilon)
{
