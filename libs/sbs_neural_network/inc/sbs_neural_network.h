...
#define ACCELERATOR_1     H1_CONVOLUTION_LAYER | H3_CONVOLUTION_LAYER | HY_OUTPUT_LAYER | H2_POOLING_LAYER
#define ACCELERATOR_2     H3_CONVOLUTION_LAYER| H4_POOLING_LAYER | H5_FULLY_CONNECTED_LAYER
