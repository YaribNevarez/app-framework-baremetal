...
SbSHardwareConfig SbSHardwareConfig_list[] =
{
  ...
  { .hwDriver      = &SbsHardwareDriver_update32,
    ...
    .hwIntVecID    = XPAR_FABRIC_SBS_UPDATE_32_0_INTERRUPT_INTR,
    .dmaTxIntVecID = 0,
  ...
  { .hwDriver      = &SbsHardwareDriver_update32,
    ...
    .hwIntVecID    = XPAR_FABRIC_SBS_UPDATE_32_1_INTERRUPT_INTR,
    .dmaTxIntVecID = 0,
  ...
  { .hwDriver      = &SbsHardwareDriver_update64,
    ...
    .hwIntVecID    = XPAR_FABRIC_SBS_UPDATE_64_0_INTERRUPT_INTR,
    .dmaTxIntVecID = 0,
  ...
  { .hwDriver      = &SbsHardwareDriver_update64,
    ...
    .hwIntVecID    = XPAR_FABRIC_SBS_UPDATE_64_1_INTERRUPT_INTR,
    .dmaTxIntVecID = 0,
  ...
  { .hwDriver      = &SbsHardwareDriver_update1024,
    ...
    .hwIntVecID    = XPAR_FABRIC_SBS_UPDATE_1024_0_INTERRUPT_INTR,
    .dmaTxIntVecID = 0,
